...
var _bluebirdExtra = require('bluebird-extra');

var _bluebirdExtra2 = _interopRequireDefault(_bluebirdExtra);
...
var fs = _bluebirdExtra2.default.promisifyAll(require("fs"));
...
function run() {
  readDir(DIR).then(function (filePaths) {
    return _bluebirdExtra2.default.all(getPartails(filePaths)).then(function (x) {
      return x;
    });
